...
const RenderHabitUtils ={
    typeConverstion: {1:"Binary",2:"Time",3:"Numeric"} as Record<number, string>, //Backend enum habit types

    /*Title seen above either active or non-active habits in the myhabits page.
    Takes habits active dates and convets them inpo a respective title*/
