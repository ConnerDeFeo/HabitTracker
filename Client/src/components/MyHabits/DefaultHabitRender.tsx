...
//This is the default habit displayed in the my habits pages
const DefaultHabitRender = (props:{habit:Habit, topLeftButton:React.ReactNode, topRightButton:React.ReactNode})=>{
    ...
    return(
        <div className="drop-shadow-xl p-3 grid gap-y-4 habitBorder w-60 lg:w-80 mx-auto">
            ...
            <div className="flex justify-between">
                ...
                <p className="text-lg lg:text-2xl">Type: {RenderHabitUtils.typeConverstion[habit.type]}</p>
            </div>
        </div>
    );
}
